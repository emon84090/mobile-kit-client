...
const Forgetpass = ({ setmodal }) => {
    ...
    return (
        <>
            ...
            <div className=" overflow-y-auto h-full top-0 bg-gray-100 overflow-x-hidden fixed  z-50 w-full md:inset-0 flex justify-center items-center md:h-full">
                <div className="relative p-4 w-full max-w-md h-full md:h-auto">
                    ...
                    <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
                        ...
                        <div className="py-6 px-6 lg:px-8">
                            <h3 className="mb-4 text-xl font-medium text-gray-900 dark:text-white">Reset Password</h3>
                            <form className="space-y-6" onSubmit={forgetform}>
