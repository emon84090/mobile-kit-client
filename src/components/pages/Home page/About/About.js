            ...
            <section className='about-all-content py-32'>
                ...
                <div className="container mx-auto">
                    <div className="about-content grid md:grid-cols-2 grid-cols-1 lg:grid-cols-3 gap-6">
                        <div class="card card-side bg-base-100 shadow-xl py-10 mt-2">

                            <div class="card-body flex-row items-center py-10">
                                <div className="icon">
                                    <i class='bx bx-home text-primary text-4xl mr-3'></i>
                                </div>
                                <div className="card-text">
                                    <h2 class="card-title">Big Inventory</h2>
                        ...
                        <div class="card card-side bg-base-100 shadow-xl mt-2">
                            ...
                            <div class="card-body flex-row items-center py-10">
                                <div className="icon">
                                    <i class='bx bx-headphone text-primary text-4xl mr-3'></i>
                                </div>
                                <div className="card-text">
                                    <h2 class="card-title">Customer Service 24/7</h2>
                        ...
                        <div class="card card-side bg-base-100 shadow-xl mt-2">
                            ...
                            <div class="card-body flex-row items-center py-10">
                                <div className="icon">
                                    <i class='bx bx-car text-primary text-4xl mr-3'></i>
                                </div>
                                <div className="card-text">
                                    <h2 class="card-title">Express Shipping</h2>
